...
from apps.AuditLog.conf import settings
from apps.AuditLog.signals import accessed
...
class AuditlogModelRegistry:
    ...
    def __init__(
        ...
        from apps.AuditLog.receivers import log_access, log_create, log_delete, log_update
    ...
    def _connect_signals(self, model):
        ...
        """
        from apps.AuditLog.receivers import make_log_m2m_changes
