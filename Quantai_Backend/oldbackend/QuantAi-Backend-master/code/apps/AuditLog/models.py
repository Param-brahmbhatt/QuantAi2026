...
from apps.AuditLog.diff import mask_str

from libs.models import SpanningForeignKey
...
class LogEntry(models.Model):
    ...
    content_type = SpanningForeignKey(
    ...
    geo_data = models.JSONField(
        blank=True, null=True, verbose_name=_("geo data")
    )
    user_agent_data = models.JSONField(
        blank=True, null=True, verbose_name=_("user agent data")
    )
